...
local TRANSFER_REJECTION_KEY_MAP = {
    ...
    generator_not_found = "UI_BarrEx_TransferRejection_GeneratorNotFound",
    source_not_found = "UI_BarrEx_TransferRejection_SourceNotFound",
    target_not_found = "UI_BarrEx_TransferRejection_TargetNotFound",
    invalid_endpoint = "UI_BarrEx_TransferRejection_Unknown",
    unsupported_endpoint = "UI_BarrEx_TransferRejection_Unknown",
    endpoint_mismatch = "UI_BarrEx_TransferRejection_TransferMismatch",
    same_endpoint = "UI_BarrEx_TransferRejection_SameEndpoint",
    ...
    ambiguous_generator = "UI_BarrEx_TransferRejection_AmbiguousGenerator",
    generator_full = "UI_BarrEx_TransferRejection_GeneratorFull",
    generator_requires_gasoline = "UI_BarrEx_TransferRejection_GeneratorRequiresGasoline",
    ...
    missing_transfer_id = "UI_BarrEx_TransferRejection_MissingTransferId",
    invalid_player = "UI_BarrEx_TransferRejection_InvalidPlayer",
    source_remove_failed = "UI_BarrEx_TransferRejection_SourceRemoveFailed",
    barrel_add_failed = "UI_BarrEx_TransferRejection_BarrelAddFailed",
    barrel_remove_failed = "UI_BarrEx_TransferRejection_BarrelRemoveFailed",
    target_add_failed = "UI_BarrEx_TransferRejection_TargetAddFailed",
    generator_add_failed = "UI_BarrEx_TransferRejection_GeneratorAddFailed",
    transfer_not_active = "UI_BarrEx_TransferRejection_TransferNotActive",
    transfer_mismatch = "UI_BarrEx_TransferRejection_TransferMismatch",
